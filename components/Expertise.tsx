        ...
        <div className="relative min-h-[auto] md:min-h-[900px]">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:block md:relative md:h-[1650px]">
            {expertise.cards.map((card, i) => {
              const positions = [
                "md:top-[10px] md:left-[5%] md:-rotate-3",
                "md:top-[450px] md:right-[5%] md:rotate-3",
                "md:top-[700px] md:left-[5%] md:rotate-2",
                "md:top-[1020px] md:right-[10%] md:-rotate-2",
                "md:top-[1340px] md:left-[15%] md:rotate-1",
              ];
              ...
              return (
                <article
                  ...
                  className={`
                    ...
                    md:absolute md:w-[350px] lg:w-[380px]
                    ${positions[i] ?? ""}
